...
#define EXCEPTION_HANDLER       0x00000004
...
/* Exception codes */
#define EX_INVALID_INSN         0x00000000
#define EX_UNALIGNED_MEMORY     0x00000001
...
#define SYS_CELL_SADDR                0xFC
#define SYS_CELL_DSTACK               0xF8
#define SYS_CELL_RSTACK               0xF4
#define SYS_CELL_STATUS               0xF0
#define SYS_CELL_TERMINATE            0xEC
#define SYS_CELL_STACKSIZE            0xE8
#define SYS_CELL_MEMSIZE              0xE4
#define SYS_CELL_CELLSIZE             0xE0
#define SYS_CELL_ID                   0xDC
...
struct quivm {
    ...
    uint32_t saddr;                 /* The address for the stack */
...
/* Fetches a value from one of the stack memories.
