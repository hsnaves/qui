...
KERNEL_DEPS := forth/utils/module.fth forth/buildkernel.fth \
 ...
 forth/kernel/compextra.fth forth/kernel/wordmain.fth forth/kernel/colon.fth \
 forth/kernel/main.fth forth/kernel/parsing.fth forth/kernel/interp.fth \
 forth/kernel/boot.fth forth/rom/control.fth forth/rom/scopeimpl.fth
...
kernel.bin: $(KERNEL_DEPS)
	$(CAT) forth/utils/module.fth forth/buildkernel.fth | $(QUI) -r rom.bin
