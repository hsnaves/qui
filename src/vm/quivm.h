...
#define INSN_SHL                      0xCB
#define INSN_USHR                     0xCC
#define INSN_SHR                      0xCD
#define INSN_ADD                      0xCE
#define INSN_SUB                      0xCF
#define INSN_NOP                      0xD0
#define INSN_DUP                      0xD1
#define INSN_DROP                     0xD2
#define INSN_SWAP                     0xD3
#define INSN_OVER                     0xD4
#define INSN_ROT                      0xD5
#define INSN_RTO                      0xD6
#define INSN_RFROM                    0xD7
#define INSN_RD                       0xD8
#define INSN_WRT                      0xD9
#define INSN_RDB                      0xDA
#define INSN_WRTB                     0xDB
#define INSN_RGET                     0xDC
#define INSN_RSET                     0xDD
#define INSN_UMUL                     0xDE
#define INSN_UDIV                     0xDF
...
struct quivm {
    ...
    void *tracer[8];                /* space for the embedded tracer struct */
};
