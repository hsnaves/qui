OBJS := dev/audio.o dev/console.o dev/devio.o dev/display.o dev/network.o \
 dev/rtclock.o dev/storage.o main.o vm/quivm.o
...
dev/devio.o: dev/devio.c vm/quivm.h dev/devio.h dev/console.h dev/storage.h \
 dev/network.h dev/rtclock.h dev/display.h dev/audio.h
